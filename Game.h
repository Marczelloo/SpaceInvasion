...
class Game {
	...
	int PausedWindowFrameThick = 5, GameOverWindowFrameThick = 5;
	Rectangle RectPausedWindow{PausedWindowX,PausedWindowY, PausedWindowWidth, PausedWindowHeight };
	Rectangle RectGameOverWindow{ PausedWindowX, PausedWindowY, PausedWindowWidth, PausedWindowHeight };
public:
	Game();
	void PausedWindow();
	void GameOverWindow();
